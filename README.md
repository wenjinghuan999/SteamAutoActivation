...
2. (By default, the script presumes English Steam client and Windows system. If using other system or language, change `IMAGE_ROOT` in `activate_keys.py` for better experience. If you don't, all the results will be `unknown`. See below for instructions.)
